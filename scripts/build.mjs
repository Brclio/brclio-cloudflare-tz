...
for (const name of ['LICENSE', 'licenses/NotoSerifSC-OFL.txt', 'THIRD_PARTY_NOTICES.md']) {
...
const zipFiles = {};
for (const name of ['_worker.js', 'index.html', '_routes.json', 'LICENSE.txt', 'THIRD_PARTY_NOTICES.txt', 'NotoSerifSC-OFL.txt']) {
