...
await build({
  ...
  banner: { js: `/* Brclio Edge ${version} | Modified 2026-09-19 by Brclio | Based on cmliu/edgetunnel 448a83ced00a43c1d892d5ecbed86a26ea9eeaff | GPL-2.0-only. See LICENSE and THIRD_PARTY_NOTICES.md. */` }
});
