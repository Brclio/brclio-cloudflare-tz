...
> 2026-09-17 重新下载实际上游源码与管理页核对，2026-09-18 复核上游 main 未变。当前源码为 v1.0.6，下方保留 v1.0.4 面板核对记录。**“已实现”不等于所有客户端与第三方服务均已在线验收**。公网部署、真实凭据与客户端验收边界见 [validation.md](validation.md)。
